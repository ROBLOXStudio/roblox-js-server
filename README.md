...
This is a primitive example server that uses my [roblox-js](https://github.com/ROBLOXStudio/roblox-js) library, allowing users to execute site actions from in-game via HttpService.
...
3. [Download](https://github.com/ROBLOXStudio/roblox-js-server/archive/master.zip) this repository and unzip.
...
2. [Redownload](https://github.com/ROBLOXStudio/roblox-js-server/archive/master.zip) the repository and unzip
